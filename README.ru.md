...
Приложение слушает только `127.0.0.1`. Размещайте его за reverse proxy с HTTPS и сохраняйте заголовки `Host` и `X-Forwarded-Proto`. Не публикуйте панель, принимающую SID/REMID, через незашифрованный HTTP.
